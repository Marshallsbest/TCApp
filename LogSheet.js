...
/**
 * Call that Calculates the Monday of the previous week
 */
function GetLastWeek(){
  let d = new Date();
  let newD = new Date();
  let day = d.getDay();
  let diff = day + (day == 0 ? 6:-1)+7;   
  newD.setDate(newD.getDate() - diff);
  let dateAsName = Utilities.formatDate(newD,"GMT-0400","MMM dd yyyy");
  return dateAsName; 
}
